  ...
  return (
    <div className="mb-10">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <div className="bg-[#141417] border border-[#2a2a2f] rounded-xl p-3 space-y-1">
            ...
            <button
              ...
              className={`w-full text-left flex items-center gap-2 px-3 py-2.5 rounded-lg border text-sm transition-colors ${
                activeId === f.id
                  ...
                  : "border-transparent text-zinc-400 hover:bg-[#1b1b1f]"
              }`}
            >
        ...
        <div className="lg:col-span-2 bg-[#141417] border border-[#2a2a2f] rounded-xl p-4">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {folder.cards.map((c) => (
              <div
                key={c.title}
                className="bg-[#1b1b1f] border border-[#2a2a2f] rounded-lg p-3"
              >
                <span className="text-sm font-medium text-zinc-200 block mb-1">
                  {c.title}
                </span>
                <span className="inline-block text-[10px] uppercase tracking-wider text-cyan-400 mb-1.5">
                  {c.meta}
                </span>

    ...
    <div className="mb-10">
      ...
      <div className="grid sm:grid-cols-3 gap-3 mb-5">
        <div className="bg-surface-card border border-white/10 rounded-lg p-3">
          <div className="text-[10px] uppercase tracking-wider text-lime mb-1">
            Set (travado)
          </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-5">
        <div>
          ...
          <select
            ...
            className="w-full bg-surface-card-elevated border border-white/10 rounded-lg px-3 py-2 text-sm text-zinc-200"
          >

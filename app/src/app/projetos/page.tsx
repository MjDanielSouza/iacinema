        ...
        <div className="bg-[#141417] border border-[#2a2a2f] rounded-xl p-5 mb-8">
          ...
          <form action={createProject} className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="submit"
              disabled={atLimit}
              className="px-5 py-2 rounded-full bg-amber-500 text-[#0a0a0c] font-semibold text-sm disabled:opacity-40 disabled:cursor-not-allowed hover:bg-amber-400 transition-colors"
            >
              Criar projeto
            </button>
          </form>
